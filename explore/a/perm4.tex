...
Considering the parity of such permutation cycles and given that  $(c_2,c_4,c_3,c_5)=(c_2,c_4)\*(c_2,c_3)\*(c_2,c_5)$ the parity of the adjacent cycles turns out to be $3.$
